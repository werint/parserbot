...
SOURCE_SERVER_4_ID = 1393772967569260627  # Четвертый сервер-источник (ДОБАВЛЕН)
...
# Роли для проверки на четвертом сервере (ДОБАВЛЕНЫ)
SOURCE_4_ROLE_IDS = [
    1393776465639899197
]
...
TARGET_ROLE_4_ID = 1485685800388530198  # Четвертая целевая роль (четвертый сервер) (ДОБАВЛЕН)
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.watching, name="4 сервера | 5 сек")
